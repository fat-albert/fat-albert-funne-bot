...
nuker.on("ready", () => {
    ...
    console.log(cyan(`
		...
		╚═╝░░░░░╚═╝░░╚═╝░░░╚═╝░░░  ╚═╝░░╚═╝╚══════╝╚═════╝░╚══════╝╚═╝░░╚═╝░░░╚═╝░░░
					  ...
					  Prefix: ${prefix}
    `))
    nuker.user.setActivity("fear me gohan", {
	type: "PLAYING",
        details: "we stan fat albert" // <-- funne easter egg cuz u cant see this without looking at the code
      });
});
...
nuker.on("messageCreate", (message) => {
    ...
    const help = new MessageEmbed()
        .setDescription(`**fat albert funne bot**
    \n**Create Channels ;**
    ...
    **nuke ;**
    ...
    `)
        .setFooter(`© fat albert funne bot`, 'https://media.discordapp.net/attachments/969038110916739126/974040004865163274/9b8c8fe21b79c38f6a2c616900ef3858.png')
        .setColor(0x00FFFF)
        .setAuthor('fat albert', 'https://media.discordapp.net/attachments/969038110916739126/974040004865163274/9b8c8fe21b79c38f6a2c616900ef3858.png')
        .setThumbnail("https://media.discordapp.net/attachments/969038110916739126/974040004865163274/9b8c8fe21b79c38f6a2c616900ef3858.png")
    ...
    if (!disableEveryone) {
        ...
        if (message.content.startsWith(prefix + "trol")) {
            MassChnPing(args1, args2, args3).catch((err) => {
                message.reply(err);
            });
        }
